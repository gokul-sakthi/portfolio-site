  ...
  items: [
    {
      ...
      description:
        "Multi-component system connecting physical kiosk terminals to a centralised admin backend — secure device registration, member wallets, RBAC, and real-time status tracking.",
      highlights: [
